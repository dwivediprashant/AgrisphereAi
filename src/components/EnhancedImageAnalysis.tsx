          ...
          <div className="mt-6 space-y-2">
            <div className="flex justify-between text-sm">
              <span>
                {results
                  ? t(
                      "imageAnalysis.translationProgress",
                      "AI Translation Progress",
                    )
                  : t("imageAnalysis.analysisProgress", "AI Analysis Progress")}
              </span>
              <span>{progress}%</span>
            </div>
            ...
            <p className="text-xs text-muted-foreground text-center">
              {results
                ? t(
                    "imageAnalysis.localizingResults",
                    "Localizing results for your region...",
                  )
                : t(
                    "imageAnalysis.processingModels",
          ...
          <Card className="p-6">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-xl font-bold">
                {t("imageAnalysis.overallPlantHealth", "Overall Plant Health")}
              </h3>
              <div className="flex gap-2 items-center">
                  ...
                  onClick={() => {
                    ...
                    toast.success(
                      t(
                        ...
                        "Result saved for offline access!",
                      ),
                    );
                  }}
                >
                ...
                <Button
                  ...
                  onClick={async () => {
                    ...
                    toast.info(
                      t(
                        "imageAnalysis.explainingAnalysis",
                        "Explaining analysis in your language...",
                      ),
                    );
                  }}
                >
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="font-medium">
                    {t("imageAnalysis.healthStatus", "Health Status")}
                  </span>
                </div>
                <p
              ...
              <div>
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="font-medium">
                    {t("imageAnalysis.imageAnalysis", "Image Analysis")}
                  </span>
                </div>
                <div className="text-sm space-y-1">
                  <p>
                    {t("imageAnalysis.plantPart", "Plant Part")}:{" "}
                    <span className="font-medium capitalize">
                      {results.imageAnalysis.plantPart}
                    </span>
                  </p>
                  <p>
                    {t("imageAnalysis.quality", "Quality")}:{" "}
                    <span className="font-medium capitalize">
                      {results.imageAnalysis.quality}
                    </span>
                  </p>
                  <p>
                    {t("imageAnalysis.processingTime", "Processing Time")}:{" "}
                    <span className="font-medium">
                      {results.imageAnalysis.processingTime}ms
                    </span>
                  </p>
                </div>
              </div>
            ...
            <Tabs defaultValue="diseases" className="w-full">
              <TabsList className="grid w-full grid-cols-4">
                ...
                >
                  ...
                  {t("imageAnalysis.diseasesTab", "Diseases")} (
                  {results.diseases.length})
                </TabsTrigger>
                <TabsTrigger value="pests" className="flex items-center gap-2">
                  <Bug className="w-4 h-4" />
                  {t("imageAnalysis.pestsTab", "Pests")} ({results.pests.length}
                  )
                </TabsTrigger>
                <TabsTrigger
                  value="nutrients"
              ...
              <TabsContent value="diseases" className="space-y-4">
                {results.diseases.length > 0 ? (
                  ...
                  <div className="text-center py-8 text-muted-foreground">
                    ...
                    <p>
                      {t(
                        "imageAnalysis.noDiseasesDetected",
