...
export type NotificationType = 'weather' | 'market' | 'disease' | 'community' | 'system' | 'irrigation' | 'schemes';
        ...
        (set, get) => ({
            ...
            markAsRead: (id) =>
                set((state) => ({
                    ...
                    unreadCount: state.notifications.filter((n) => n.id !== id && !n.read).length, // Recalculate accurately
                })),
